...
description: "Plan user research or synthesize behavioral evidence."
---
...
For interviews, plan synthesis up front: one observation per note, tagged with the question it speaks to, raw quotes over summaries. Choose study size based on the question and diversity of the population; do not assume a universal saturation count.
...
Choose the technique that fits: in Plan, the method matched to the learning goal; in Synthesise, extraction → patterns → candidate stories. Do the next useful thing, not a full battery.
