...
class DiscoverRepositoryTests(unittest.TestCase):
    ...
    def test_discovery_finds_leads_without_authorizing_cleanup(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            (root / "next-env.d.ts").write_text("generated\n", encoding="utf-8")
            ...
            self.assertEqual(result["schema"], "clean-up-discovery/v3")
            ...
            self.assertEqual(targets[("path", "next-env.d.ts")]["signal"], "generated-residue")
