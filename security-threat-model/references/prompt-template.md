...
7) Validate assumptions and service context with the user (required before final report)
   ...
   - Ask only about material unresolved context. Continue independent analysis; use established facts without reconfirmation and label conditional recommendations when uncertainty remains.
