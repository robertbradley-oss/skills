...
description: "Produce a repository-grounded threat model when requested."
---
...
- Use existing context to establish threat ranking and scope. Ask only about unresolved assumptions that materially change the report.
- Ask 1–3 targeted questions to resolve missing context (service owner and environment, scale/users, deployment model, authn/authz, internet exposure, data sensitivity, multi-tenancy).
- Continue independent analysis while a question is pending. Do not require confirmation of facts already established; label unresolved assumptions and conditional recommendations.
