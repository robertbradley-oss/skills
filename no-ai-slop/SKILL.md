---
name: no-ai-slop
description: "Edit a draft for clarity and voice, or flag writing patterns without rewriting."
---
...
- **Use active voice.** "The team shipped it Tuesday" beats "the decision emerged." Avoid strained personification when it obscures the meaning.
...
- **Be concrete and specific.** Abstraction is where writing goes to die. "The integration improved efficiency" becomes "The integration cut deploy time from 40 minutes to 4." Use names, numbers, dates, mechanisms, and examples only when supported by the draft or evidence; the numerical rewrites here are illustrative, never facts to invent.
