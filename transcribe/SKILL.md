---
name: "transcribe"
description: "Transcribe audio or video with optional speaker labels."
---
...
```bash
TRANSCRIBE_SKILL_HOME="${CODEX_HOME:-$HOME/.codex}"
export TRANSCRIBE_CLI="$TRANSCRIBE_SKILL_HOME/skills/transcribe/scripts/transcribe_diarize.py"
```
