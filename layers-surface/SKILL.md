---
name: layers-surface
description: "Review whether interface details match the product model and task flow."
---
...
Choose the technique that fits the live concern — a vocabulary check when terms feel off, a feedback inventory when users don't know what happened, an accessibility pass when it's been left to defaults. Don't run all ten.
