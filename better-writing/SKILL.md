---
name: better-writing
description: "Write or review interface labels, instructions, errors, and empty states."
---
...
| Invalid name | Enter the name required for this record |
| Oops! Something went wrong. | Unable to save. Check your connection and try again. |

No blame, no "oops", no exclamation marks. Phrase hints positively when doing so accurately describes the product requirement and show them before the mistake, not after. If the same error keeps firing for many users, redesign the interaction instead of rewording it.
...
For an audit, report confirmed findings with location, impact, evidence, and a suggested correction. For requested fixes, apply the in-scope changes and verify them. Use an output format proportional to the task; do not require a separate table or verdict for each loaded skill. Preserve the project's conventions and current user direction.
