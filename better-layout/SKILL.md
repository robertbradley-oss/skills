---
name: better-layout
description: "Design or review web layout, grouping, spacing, and responsive structure."
---
...
Hit-area sizes and focus behavior are covered by the `accessibility` skill; visual polish (radius, shadows, animation) by the the relevant frontend implementation or motion skill skill; line length and text spacing by the `better-typography` skill.
