...
| Clean Up | Resolve file, artifact, release, duplicate, organization, branch, worktree, and tracked-code evidence into safe cleanup verdicts and approved recovery-backed removal. | [`clean-up/`](clean-up/) |
