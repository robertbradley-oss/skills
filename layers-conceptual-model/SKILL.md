...
description: "Define product objects, relationships, states, and vocabulary."
---
...
Find which of the decisions above are live. Choose the technique that fits: noun foraging if there's material to mine, walking the product if redesigning, or straight to object definition if the objects are known and only their shape is open. Do the next useful thing, not the whole toolkit.
