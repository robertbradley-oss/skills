...
description: "Name a web animation effect from its visual description."
---
...
2. **Use the glossary as a reference.** Explain the term accurately in wording that fits the user's question.
...
5. **Go beyond the glossary when necessary.** Use a supported established term, or state that your description is approximate; do not invent terminology.
