---
name: better-colors
description: "Create or review color palettes, tokens, contrast, and gamut behavior."
---
...
| Color notation differs from a proposed example | Preserve the project format unless a migration is requested |
