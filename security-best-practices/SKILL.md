...
description: "Review security practices or implement requested secure defaults for supported stacks."
---
...
3. The user can ask for a security report or to improve the security of the codebase. In this case a full report should be produced describe anyways the project fails to follow security best practices guidance. The report should be prioritized and have clear sections of severity and urgency. For a combined review-and-fix request, proceed with the authorized fixes. See #fixes below.
...
For a report-only request, deliver findings. If the user requested fixes, continue with authorized remediation and verification without another approval pause.
